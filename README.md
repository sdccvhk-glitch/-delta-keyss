...
- Admin login uses USERNAME + PASSWORD only; no email and no secret code.
- Admin login is remembered for 24 hours on the device and Logout clears the saved login.
