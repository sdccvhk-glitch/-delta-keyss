...
app.post("/api/orders", (req, res) => {
  ...
  const order = {
    ...
    customerName: String(customerName || "Guest customer").trim(),
    customerContact: String(customerContact || "Not provided").trim(),
    paymentReference: String(paymentReference || "Pending manual verification").trim(),
    status: "pending",
    key: "",
    createdAt: now,
    updatedAt: now
